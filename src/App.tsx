  ...
  return (
    <main className="min-h-screen bg-stone-300 py-40">
      <section className="p-8 bg-white mx-auto max-w-96 rounded-3xl text-center">
        ...
        <h1 className='mt-5 text-3xl font-bold text-stone-800 font-display'>Preencha o Código</h1>
        <p className='mt-1 text-sm text-stone-400'>Enviamos um código por E-mail e por SMS</p>
        <OtpForm />
      </section>
    </main>
  )
